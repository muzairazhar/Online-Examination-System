...
@endif
                ...
                @if (count($questions) > 0)
                    @foreach ($questions as $question)
                        <tr class="">
                            ...
                            <td><a href="#" class="btn btn-primary ansbtn" data-id="{{ $question->id }}"
                            ...
                            <td>
                                <button class="btn btn-primary editbtn " data-id="{{ $question->id }}"
                                    ...
                                    <button class="btn btn-danger deletebtn " data-id="{{ $question->id }}"
    ...
    {{-- delete-Questions-modal-ends --}}

    
    {{-- Import-Question-modal-start --}}
