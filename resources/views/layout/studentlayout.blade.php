  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<h1>
          <a href="/admin/dashboard" class="logo"  style="text-decoration: none">Hi:{{ Auth::user()->name }}
        </a>
      </h1>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active" style="text-decoration: none">
            <a href="{{ route('paidexams') }}"   style="text-decoration: none" >
              <span class="fa fa-tasks mr-3"></span>Paid Exams</a>
          </li>

          <li class="active" style="text-decoration: none">
            <a href="{{ route('paidpackage') }}"   style="text-decoration: none" >
              <span class="fa fa-gift mr-3"></span>Paid Package</a>
          </li>

          <li class="active" style="text-decoration: none">
            <a href="{{ route('resultdashboard') }}"   style="text-decoration: none" >
