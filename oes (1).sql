...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2024 at 09:03 PM
...
CREATE TABLE `exams` (
  ...
  `plan` int(255) NOT NULL DEFAULT 0 COMMENT '0->free 1->paid',
...
('muzairazhar0@gmail.com', '0yWcM8sxveQbb9MHDKa3t8S7LYM6BRXpVLLDB90S', '2024-03-29 10:04:27'),
('muzairazhar0@gmail.com', '0yWcM8sxveQbb9MHDKa3t8S7LYM6BRXpVLLDB90S', '2024-03-29 10:04:27');
...
(1, 'admin', 'admin@gmail.com', NULL, 1, '$2y$10$Lu8Nl91bUIbkSvp.RiDRAetcCe1QuzOfHRlS1cMvHIzka82Hz7ZGm', NULL, '2024-06-07 10:16:24', '2024-06-07 10:16:24'),
(2, 'student', 'student@gmail.com', NULL, 0, '$2y$10$NSXZLf5lVsb/ZKQX8WeCAu3sdiL.DCMdgNj2pQuoCMCpSdo4y.Loe', NULL, '2024-06-07 10:17:10', '2024-06-07 10:17:10');
...
--
-- Indexes for table `exams_answer`
--
...
--
-- AUTO_INCREMENT for table `exams_answer`
--
ALTER TABLE `exams_answer`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
